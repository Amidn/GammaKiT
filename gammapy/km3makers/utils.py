...
def km3_get_fov_coords(pointing, irf, geom, use_region_center=True, obstime=None):
...
def make_edisp_map(edisp, pointing, geom, exposure_map=None, use_region_center=True):
    ...
    """
    coords =  km3_get_fov_coords(pointing, edisp, geom, use_region_center=use_region_center)
    coords["energy_true"] = broadcast_axis_values_to_geom(geom, "energy_true")
